...
const Contact = () => {
	return (
		<section className="text-stone-800 body-font relative h-screen grid items-center">
			...
			<div className="container px-5 py-24 mx-auto flex">
				<div className="lg:w-1/3 md:w-1/2 bg-stone-100 shadow-md rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">

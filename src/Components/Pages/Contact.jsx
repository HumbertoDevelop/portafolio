	...
	return (
		<section
			...
			<div className="container px-5 py-24 mx-auto flex">
				<div className="lg:w-1/3 md:w-1/2 bg-gradient-to-r from-indigo-600 to-sky-500 text-white shadow-md rounded-lg p-8 flex flex-col smx2:flex-wrap md:ml-auto w-full mt-10 md:mt-0 relative z-10">
					...
					https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=new"
						target="_blank"
						rel="noreferrer">
						<button className="text-zinc-800  border-0 py-2 px-6 focus:outline-none hover:bg-stone-300 bg-white rounded text-lg">
							Send a email
						</button>
					</a>
				</div>
